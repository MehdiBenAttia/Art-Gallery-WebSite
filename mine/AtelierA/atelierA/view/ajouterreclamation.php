...
//Ssi l'utilisateur est un achteur ayant un compte
                session_start();
		...
		<div class="container">
			<div class="flex-w flex-tr">
				<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
                 ...
                 <td> <input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="messagereclamation" id="messagereclamation" > </td> </tr>
				 ...
				 <div class="bor8 m-b-30">
				  <tr> <td> <input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="emailreclamation" id="emailreclamation" maxlength="11"> </td> </tr>
                 </div>
