...
<?php
	...
	$sql = 'SELECT COUNT(*) AS nb_produit FROM `produit`;';
	...
	$nbArticles = (int) $result['nb_produit'];
	...
	$listeproduit = $query->fetchAll(PDO::FETCH_ASSOC);




	//include_once 'Produit/View/CRUDproduit.php';
	$produit = null;
	...
	//  //$listeproduit = $bdd->query('SELECT * FROM produit ORDER BY prix_produit DESC');
	// if (isset ($_GET['s']) AND !empty($_GET['s'])){
    //   $recherche =	htmlspecialchars($_GET['s']);
	//   $listeproduit = $bdd->query('SELECT * FROM produit WHERE nom_produit LIKE "%' .$recherche .'%" ORDER BY prix_produit DESC '  ); 
	// }
	// if (isset($_POST['ASC'])) {
    //     $produitC=new produitC();
    //     $listeproduit = $produitC->afficherproduittri();
    // }
				...
				<ul class="header-cart-wrapitem w-full">
					<li class="header-cart-item flex-w flex-t m-b-12">
						<div class="header-cart-item-img">
							<!--<img src="images/peinture/1.jpg" alt="IMG">-->
						</div>
					...
					<li class="header-cart-item flex-w flex-t m-b-12">
						<div class="header-cart-item-img">
							<img src="images/peinture/2.jfif" alt="IMG">
						</div>
					...
					<li class="header-cart-item flex-w flex-t m-b-12">
						<div class="header-cart-item-img">
							<img src="images/peinture/3.jfif" alt="IMG">
						</div>
	...
	<div class="bg0 m-t-23 p-b-140">
		<div class="container">
			<div class="flex-w flex-sb-m p-b-52">
				<div class="flex-w flex-l-m filter-tope-group m-tb-10">
					...
					<?php
                          foreach($listecategorie as $categorie){
                            ?>
					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".<?php echo $produit['produit_categorie'];?>">
				...
				<div class="flex-w flex-c-m m-tb-12">
        ...
        <option value="all" >Tous</option>
          ...
          <input type="submit" name="chercher" value="Valider" class="m-t-0 flex-c-m text-center size-105 bor4 pointer hov-btn3  m-tb-4" style="width: 180px;">
				...
				<input type="button" value="Imprimer" onClick="window.print()" class=" m-l-10 btn btn-outline-secondary ">
			...
			<!--  -->
                          ...
                          foreach($listeproduit as $produit){
                            ?>
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-30 isotope-item <?php echo $produit['categorie_produit']; ?> ">
					<!-- Block2 -->
					...
					<div class="block2">
						...
						<div class="block2-pic hov-img0">
							<img id ="images" src="../images/Peinture/<?PHP echo $produit['image_produit']; ?>" alt="IMG-PRODUCT">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="product-detail.php?id_produit=<?php echo $produit['id_produit'] ?>" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
								<?PHP echo $produit['nom_produit']; ?>
								</a>

								<span class="stext-105 cl3 m-b-30">
								<?PHP echo $produit['prix_produit']; ?>,00 TND
								</span>
							</div>
							<a href="mailer.php?id_produit=<?php echo $produit['id_produit'] ; ?>" class="btn btn-block btn-outline-info ">Partagez</a>
		...
		<nav>
                    <ul class="pagination flex-c-m flex-w w-full p-b-40 ">
