			...
			<div class="row">
					...
					<div class="p-l-25 p-r-30 p-lr-0-lg">
						<div class="wrap-slick3 flex-sb flex-w">
							...
							<div class="slick3 gallery-lb">
								<div class="item-slick3" data-thumb="../images/Peinture/<?php echo $produit['image_produit']  ?>">
									<div class="wrap-pic-w pos-relative">
										<img src="../images/Peinture/<?php echo $produit['image_produit']  ?>" alt="IMG-PRODUCT">
								...
								<!-- <div class="item-slick3" data-thumb="images/Peinture/">
									<div class="wrap-pic-w pos-relative">
										<img src="images/Peinture/" alt="IMG-PRODUCT">
				...
				<div class="col-md-6 col-lg-5 p-b-30">
					<div class="p-r-50 p-t-5 p-lr-0-lg">
						...
						<?php echo $produit['prix_produit']  ?> TND
						</span>
		...
		<div class="container">
			...
			<div class="wrap-slick2">
				...
				<?php   
							...
							?>
					<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15 isotope-item">
						
						<!-- Block2 -->
						<div class="block2">
							<div class="block2-pic hov-img0">
								<img src="../images/peinture/<?PHP echo $produit['image_produit']; ?>" style="height:200px width:200px;"  alt="IMG-PRODUCT">
							...
							<div class="wrap-slick3 flex-sb flex-w">
								...
								<div class="slick3 gallery-lb">
									<div class="item-slick3" data-thumb="images/product-detail-01.jpg">
										<div class="wrap-pic-w pos-relative">
											<img src="images/peinture/acrylique" alt="IMG-PRODUCT">
