<?php
    ...
    if (
        ...
        if (
            ...
            !empty($_POST["codepostallivraisonlivraison"]) 
          ...
          //  header('Location:CRUDlivraison.php');
                      ...
                      <?php
                        ...
                        <tr>
                            ...
                            <td>
                                      ...
                                      <input type="hidden" value=<?PHP echo $livraison['codelivraison']; ?> name="codelivraison">
                                      </form>
                            </td>
                            <td>
                                <a class="btn btn-light" href="modifierlivraison.php?codelivraison=<?PHP echo $livraison['codelivraison']; ?>"> Modifier les données </a>
                            </td>
