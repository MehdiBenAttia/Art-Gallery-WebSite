<?php
    ...
    if (
        ...
        if (
            ...
            $produitC->modifierProduct($produit,$_GET['id_produit']);
      ...
      <div class="main-panel">
		...
		?>
                  ...
                  <div class="form-group">
                      ...
                      <input type="text" name="id_produit" class="form-control" id="id_produit"  value = "<?php echo $produit['id_produit']; ?>" disabled>
                    </div>
                    <div class="form-group">
                      <label for="nom_produit">Nom du produit</label>
                      <input type="text" name="nom_produit" class="form-control" id="nom_produit"  value = "<?php echo $produit['nom_produit']; ?>">
                    </div>
                    <div class="form-group">
                      <label class="btn btn-primary mr-2" for="image_produit"  >Image du produit </label>
                      <input type="file" name="image_produit" style="display:none;"class="form-control" id="image_produit"  value = "../../../images/<?php echo $produit['image_produit']; ?>">
                    </div>
                    <div class="form-group">
                      <label for="description_produit">Description du produit</label>
                      <input type="texte"  name="description_produit" class="form-control" id="description_produit"  value = "<?php echo $produit['description_produit'] ; ?>">
                    </div>
                    <div class="form-group">
                      <label for="prix_produit">Prix du produit</label>
                      <input type="number"  name="prix_produit"class="form-control" id="prix_produit"  value = "<?php echo $produit['prix_produit']; ?>">
                    </div>
                    <div class="form-group">
                      <label for="categorie_produit">Catégorie du produit</label>
                      <input type="Texte" name="categorie_produit" class="form-control" id="categorie_produit"  value = "<?php echo $produit['categorie_produit']; ?>" readonly >
                    </div>
                    ...
                    <hr>
                    <a href="CRUDproduit.php" class="btn btn-info mr-2">Ajouter un produit</a>
                  </form>
                  <?php
            }
                  ?>
                      ...
                      <?php
                        ...
                        <tr>
                            ...
                            <td>
                                      ...
                                      <a class="btn btn-outline-success" href="modifierproduct.php?id_produit=<?PHP echo $produit['id_produit']; ?>" name="Modifier" > Modifier </a>
