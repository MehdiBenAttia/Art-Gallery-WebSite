...
if(!isset($_SESSION["idutilisateur"])){
    var_dump($_SESSION);
    header("Location: ../atelierA/view/login.php");
    exit(); 
  }
  ...
  <header class="header-v4">
            ...
            <div class="wrap-menu-desktop how-shadow1">
                <nav class="limiter-menu-desktop container">
                    ...
                    <div class="menu-desktop">
                        <ul class="main-menu">
                            <li>
                                <a href="../atelierA/view/showpromotion.php">Accueil</a>
                                <ul class="sub-menu">
                            ...
                            <li>
                    <a href="../atelierA/view/product.php">Produits</a>
                            </li>
                            ...
                            <li>
                                <a href="../atelierA/view/showarticle.php">blog</a>
                            </li>
                            ...
                            <li>
                                <a href="#">S.A.V</a>
                                <ul class="sub-menu">
                                    <li><a href="../atelierA/view/ajouterreclamation.php"> Reclamation</a></li>
                                    <li><a href="../atelierA/view/ajoutercartefidalite"> carte-fidelité</a></li>
                                </ul>
                            </li>
        ...
        <div class="menu-mobile">
            ...
            <ul class="main-menu-m">
                ...
                <li>
                    <a href="../atelierA/view/modifyutilisateur.php">About</a>
                </li>
